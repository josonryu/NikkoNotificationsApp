...
App.factory('logFileSend', ['AppComLog', 'appConst', function (AppComLog, appConst) {
         ...
         * @return void
         */
        function uploadLog(sucessCallback, errorCallbackServerRes, errorCallbackPost) {
            // ログファイル送信
            AppComLog.uploadLog((subif010Recv, status, time) => {
                // 成功
         ...
         * @return void
         */
        function deleteLog(time, sucessCallback, errorCallback) {
            // ログ削除
        ...
        return {
             ...
             * @return void
             */
            logFileSend(sucessCallback, errorCallbackServerRes, errorCallbackPostTimeout, errorCallbackDelete) {
                // ログをサーバに送信する
                uploadLog((time) => {
                    // 成功時はログ削除を実行
