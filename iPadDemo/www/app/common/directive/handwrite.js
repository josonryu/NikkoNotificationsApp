...
App.directive('handWrite', ['$parse', 'AppBizCom', 'AppCom', function ($parse, AppBizCom, AppCom) {
        return {
            ...
            link: function (scope, element, attrs) {
                ...
                var proper = loginInfo.PROPER_C || 'noUser';
                var shop = loginInfo.PROPER_C ? loginInfo.UKETSUKE_MISE_C : '000';
                var section = loginInfo.PROPER_C ? loginInfo.UKETSUKE_KAKARI_C : '0000';
                var id = attrs.id;
                var initInfo = $parse(attrs.handWrite)(scope);
