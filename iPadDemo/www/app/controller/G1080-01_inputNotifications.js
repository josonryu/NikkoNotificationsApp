    ...
    function ($scope, $routeParams, $anchorScroll, $timeout, $controller, AppCom, AppBizCom, logicCom, AppLgcMultiCheck, chkSimilarConst, AppBizNaviScroll, appDefine, AppLgcApplyAssign, AppBizMsg) {
        ...
        var checkRuitouSuknKaitTeiBefore = function (checkResult) {
            ...
            if (AppBizCom.InputCheck.isEmpty($scope.ruiTouSunk.RUITOU_SUKN_KAIT_TEIS_K)) {
                ...
                showErrorItemsGroup(target, AppBizCom.Msg.getMsg(msgId, ['累投（株投型）分配金買付停止']), msgId, true);
                checkResult1Update(target, value, msgId, checkResult);
                return true;
            }
            else {
        ...
        var checkIsKabusu = function (checkResult) {
            ...
            if (nisaKozaHireihaibunNotEmpty && haitknSyknUktrMskmNotEmpty) {
                ...
                showErrorItemsGroup('chkboxHireihaibun', AppBizCom.Msg.getMsg(msgId, param), msgId, true);
                showErrorItemsGroup('radioHaitkinSunk', AppBizCom.Msg.getMsg(msgId, param), msgId, true);
                if (checkResult) {
                    checkResult1Update(target1, value1, msgId, checkResult);
                    checkResult1Update(target2, value2, msgId, checkResult);
                }
        ...
        var inputData = {
            ...
            gaikSyknKoza: {
                GAIK_SYKN_KOZA: {
                    applyName: 'GAIK_SYKN_KOZA',
                    id: 'chkboxGaikSyknKozaMRF',
                    name: '外国証券取引口座',
                    typeSelect: true,
                    allChk: [['isEmpty']],
                },
            ...
            kaNyu: {
                KANYUSY_EXP_TORK_K: {
                    applyName: 'KANYUSY_EXP_TORK_K',
                    id: 'chkboxKanyusyExpTorkK',
                    name: '拡張情報',
                    typeSelect: true,
                    allChk: [['isEmpty']],
                },
            ...
            nisa: {
                ...
                HIREIHAIBUN: {
                    ...
                    id: 'chkboxHireihaibun',
                    name: '株式数比例配分方式申込',
                    typeSelect: true,
                    allChk: [[checkNisaKozaHireihaibun]],
                },
            },
            // 個人番号告知
            myNumber: {
            ...
            suknMeigara: {
                SUKN_HKT_MEIG_K: {
                    applyName: 'SUKN_HKT_MEIG_K',
                    id: 'chkboxSuknHktK',
                    name: '利金・分配金支払方法（銘柄）',
                    typeSelect: true,
                    allChk: [['isEmpty'], [checkSuknHktMeigk]],
                },
            },
            // 外国証券の円貨利金分配金振込銀行
            gaikSukn: {
            ...
            haitkinSunk: {
                HAITKN_SYKN_UKTR_MSKM: {
                    applyName: 'HAITKN_SYKN_UKTR_MSKM',
                    id: 'radioHaitkinSunk',
                    name: '申込区分',
                    typeSelect: true,
                    allChk: [['isEmpty'], [checkHaitknSyknUktrMskm]],
                },
                AMEIG_FURIKOMI_CHK: {
                    applyName: 'AMEIG_FURIKOMI_CHK',
                    id: 'checkHaitkinSunk',
                    name: '受取方法',
                    typeSelect: true,
                    allChk: [[checkAmeigFurikomiChkIsEmpty]],
                },
                AMEIG_FURIKOMI: {
                    applyName: 'AMEIG_FURIKOMI',
                    id: 'txtAmeigFurikomi',
                    name: '登録銀行No.',
                    typeSelect: false,
                    length: 2,
                    numPad: true,
                    onBlurChk: [[checkAmeigFurikomiIsNum]],
                    allChk: [[checkAmeigFurikomiIsEmpty], [checkAmeigFurikomiIsNum, checkAmeigFurikomiSameLength], [checkAmeigFurikomiIsAllowed, checkAmeigFurikomi1, checkAmeigFurikomi2, checkAmeigFurikomi3, checkAmeigFurikomi4, checkAmeigFurikomi5]],
                }
            },
        };
        // ------------------------------------ ここから内部処理メッソド START ------------------------------------ //
        ...
        var setNotifInfo = function () {
            ...
            notifInfo.JIMU_JOHO = Object.assign(nameJimuJoho, addrJimuJoho, telsJimuJoho, mrfJimuJoho, nkCardJimuJoho, ezTradeJimuJoho, gaikSyknKozaJimuJoho, tkKozaJimuJoho, tkKanriKozaJimuJoho, kaNyuJimuJoho, nisaJimuJoho, myNumberJimuJoho, addKozaJimuJoho, suknHoukatsuJimuJoho, suknMeigaraJimuJoho, gaikSuknJimuJoho, ruiTouSunkJimuJoho, 
            // 2020/11/19 インシデント対応 削除開始
            //haitkinSunkJimuJoho);
            // 2020/11/19 インシデント対応 削除終了
            // 2020/11/19 インシデント対応 追加開始
            haitkinSunkJimuJoho, delKozaTrkNoListJoho);
            // 2020/11/19 インシデント対応 追加終了
         ...
         */
        $scope.$watchCollection('kozaDel', function (newArr, oldArrr) {
            // 口座未削除数
