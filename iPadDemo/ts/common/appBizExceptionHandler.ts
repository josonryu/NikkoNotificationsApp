    ...
    writeLog(dateTime, message, level) {
        try {
            if (selfAceh.errLogDb) {
                selfAceh.errLogDb.executeSql('INSERT INTO LOG(PROPER_CD, UKETSUKE_MISE_CD, UKETSUKE_KAKARI_CD, LOG_TIME, IDO, KEIDO, APL_KBN, LEVEL, MESSAGE, ACTION) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)',
                    ['noUser', '000', '0000', dateTime, null, null, '2', level, '-', message]);
            } else {
