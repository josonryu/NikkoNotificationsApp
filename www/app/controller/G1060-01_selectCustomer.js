...
App.controller('selectCustomerController', ['$scope', '$location', '$controller', 'AppCom', 'AppBizCom', 'appConst', 'logicCom', 'APL_NAME', 'AppLgcMultiCheck', 'AppBizDataHolder', 'AppBizMsg',
    function ($scope, $location, $controller, AppCom, AppBizCom, appConst, logicCom, APL_NAME, AppLgcMultiCheck, AppBizDataHolder, AppBizMsg) {
        ...
        var GAMEN_PREV = { ID: 'G1040-01', NAME: 'homeMenu' }; //受付場所の選択
        /** ボタン名／名称 */
        var BTN_SEARCH = '検索';
        var BTN_PREV = '戻る';
        /** ボタン連打防止フラグ */
        ...
        var successCallback = function (SUBIF005Recv, status) {
            SUBIF005Recv = {
                RESULT_CODE: appConst.SUBIF005.RESULT_CODE.OK,
                JTK_DNW_BNG: '03-1111-2222',
                KTI_DNW_BNG: '090-3333-4444',
                FAX_BNG: '',
                MISE_C: '0003',
                KYAK_CIF_C: '7891012',
                KOZA_OPENYMD: '20240101',
                KAKARI_C: '0037',
                SIMEI_SEI: '三井',
                SIMEI_MEI: '一郎',
                KANA_SEI: 'ミツイ',
                ...
                CHIKI_CD: '2501013',
                YBN_BNG: '1008325',
                KYAK_JYSY_KNJ: '東京都千代田区丸の内',
                KYAK_JYSY_KN: 'トウキョウト　チヨダク　マルノウチ',
                HSK_JYSY_KNJ: '３‐３‐１',
                HSK_JYSY_KN: '３‐３‐１',
                TTMN_NM_KNJ: '新東京ビル　Ｂ棟　８０１号室',
                TTMN_NM_KN: 'シントウキョウビル　ビートウ　８０１ゴウシツ',
                MYNO_NOTICE: '0',
                MARU_YU: '',
                DIRECT_COURSE: '',
                NIKKO_MRF: '0',
                ...
                NIKKO_EZ_MSKMB: '',
                DNS_KOFU_SRV: '',
                GAIK_SYKN_KOZA_OPENYMD: stringConst.ZeroYMD,
                TKTEI_KOZA_OPENYMD: stringConst.NineYMD,
                TKTEI_KOZA_AC: '',
                TKTEI_KOZA_GNSN: '',
                TKTEI_KOZA_YYKYMD: '20240101',
                TKTEI_KOZA_YYK: '1',
                TKTEI_KOZA_NENSY_TORIHIKIYMD: '',
                TKTEI_KANRI_KOZA_OPENYMD: stringConst.ZeroYMD,
                KAKU_KYAKNM_KNJ: '',
                KAKU_YUBINNO: '',
                KAKU_ADDR: '',
                NISA_KOZA_OPENYMD: stringConst.ZeroYMD,
                KOZA: [
                    {
                        KOZA_TRKNO: '01',
                        KOZA_UKTRKZ: '1',
                        KOZA_BK_C_BK: '0009',
                        KOZA_MISE_C_BK: '001',
                        KOZA_BK_NM_BK: '三井住友銀行',
                        KOZA_MISE_NM_BK: '新保町支店',
                        KOZA_YOKNKND_BK: '1',
                        KOZA_KOZA_CD_BK: '123456',
                        BK_KOZA_KANA: 'ミツイ　イチロウ',
                    },
                    // {
                    //     KOZA_TRKNO: '01',
                    //     KOZA_UKTRKZ: '0',
                    //     KOZA_BK_NM_BK: 'ゆうちょ銀行',
                    //     YUCH_BK_C: '199',
                    //     YUCH_BK_KOZA_C: '9999991',
                    // },
                ],
                SUKN_SITEI_K: '0',
                SUKN_SYURUI_K: '20',
                SUKN_HKT_BK: '01',
                GAIK_SYKN_YEN_SUKN_BK_HKT: '01',
                GAIK_SYKN_YEN_SUKN_BK_MEIG: [{'GAIK_SYKN_YEN_SUKN_BK_MEIG_MEIG_CD': '9999991', 'GAIK_SYKN_YEN_SUKN_BK_MEIG_KOZA': '01'}],
                HAITOUKIN: '',
                AMEIG_FURIKOMI: '',
                SOUHUSAKI_YBN_BNG: '',
                SOUHUSAKI_JYSY_KNJ: '',
