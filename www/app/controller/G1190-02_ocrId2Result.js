...
App.controller('ocrId2ResultController', ['$scope', '$controller', 'appConst', 'AppBizCom', 'logicCom', '$anchorScroll', '$timeout', 'AppBizCamera',
    function ($scope, $controller, appConst, AppBizCom, logicCom, $anchorScroll, $timeout, AppBizCamera) {
        ...
        // 本人確認書類データ取得
        var personDocInfos = AppBizCom.MstData.getCodeMstDataByCd('HONIN_KAKNIN_SY', selectedInfo.HONIN_KAKNIN_SY_K_2);
        // 塗りつぶし対象書面フラグ
        var isFillImage = false;
        // 塗りつぶし画面スキップフラグ
        var skipMaskFlg = false;
        var skipMaskFlg2 = false;
        // // 自動マスク画像情報の有無
        ...
        */
        ...
        $scope.backBtnClickYes = () => {
            ...
            var path = 'selectIdentificationDoc';
            // ログ出力
