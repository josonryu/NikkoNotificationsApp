...
App.controller('inputNotificationsController', ['$scope', '$routeParams', '$anchorScroll', '$timeout', '$controller', 'AppCom', 'AppBizCom', 'logicCom', 'AppLgcMultiCheck', 'chkSimilarConst', 'AppBizNaviScroll', 'appDefine', 'AppLgcApplyAssign', 'AppBizMsg',
    function ($scope, $routeParams, $anchorScroll, $timeout, $controller, AppCom, AppBizCom, logicCom, AppLgcMultiCheck, chkSimilarConst, AppBizNaviScroll, appDefine, AppLgcApplyAssign, AppBizMsg) {
        ...
        var getKozaBeforeArray = function (val) {
            if (val == undefined || !angular.isArray(val))
                return [];
            val.forEach(e => {
                // 登録銀行No
        ...
        var getSuknHoukatu = function () {
            ...
            if ($scope.suknBefore.SUKN_SITEI_K == '0' || $scope.suknBefore.SUKN_SITEI_K == '3') {
                ...
                switch ($scope.suknBefore.SUKN_SYURUI_K) {
                    ...
                    case '30':
                        // 「20:銀行振込出金」、「30:郵貯」
                        var koza = $scope.kozaBefore.KOZA.find(k => k.KOZA_TRKNO === $scope.suknBefore.SUKN_HKT_BK);
                        if (koza) {
                            res = koza.KOZA_BK_NM;
                        } else {
        ...
        var getGaikSunkHoukatsu = function (val) {
            if (val == '' || val == undefined) {
                ...
                var koza = $scope.kozaBefore.KOZA.find(k => k.KOZA_TRKNO === val);
                if (koza) {
                    return koza.KOZA_BK_NM;
                } else {
                    return '登録銀行No ' + padLeft(val, 2);
                }
            }
        };
        /**---------------------------------------------------------------
         * 外国証券の円貨利金分配金振込先(銘柄／受取口座)（変更前）出力編集
         *
         * @param {Array} val - 入力値
         * @return {Array} - 編集した結果
         */
        var getGaiSunkMeigara = function (val) {
            ...
            val.forEach(e => {
                // 登録銀行No
                var koza = $scope.kozaBefore.KOZA.find(k => k.KOZA_TRKNO === e.GAIK_SYKN_YEN_SUKN_BK_MEIG_KOZA);
                if (koza) {
                    e.GAIK_SYKN_YEN_SUKN_BK_MEIG_KOZA = koza.KOZA_BK_NM;
                } else {
        ...
        /**---------------------------------------------------------------
         * 外国証券の円貨利金分配金振込先(銘柄／受取口座)（変更前）出力編集 （銘柄／受取口座なしの場合）
         *
         * @param {Array} val - 入力値
        ...
        var beforeEditDataDefine = {
            // お客様口座情報
            kozaInfo: [
                { target: 'KOZA_OPEN_YMD', get: [formatYMD] },
                'MISE_C',
                'KYAK_CIF_C' // 顧客コード
            ],
            // おなまえ
            ...
            // 日興イージートレード
            ezTradeBefore: [
                { target: 'NIKKO_EZ', get: [formatYMD, stringConst.Mimoshikomi] },
                { target: 'DNS_KOFU_SRV', get: [getNmWithCd, 'KIYK_K'] } // 電子交付サービス
            ],
            // 特定口座
            tkKozaBefore: [
                { target: 'TKTEI_KOZA_OPENYMD', get: [formatYMD, stringConst.Mikaisetsu] },
                'TKTEI_KOZA_AC',
                { target: 'TKTEI_KOZA_AC', key: 'TKTEI_KOZA_AC_NM', get: [getNmWithCd, 'ACKBN'] },
                'TKTEI_KOZA_GNSN',
                { target: 'TKTEI_KOZA_GNSN', key: 'TKTEI_KOZA_GNSN_NM', get: [getNmWithCd, 'GNSEN_TYOSYU_K'] },
                'TKTEI_KOZA_YYKYMD',
                'TKTEI_KOZA_YYK',
            ...
            suknBefore: [
                ...
                'SUKN_SYURUI_K',
                'SUKN_HKT_BK',
                { target: 'SUKN_HOUKATSU', get: [getSuknHoukatu] },
            ],
            // 外国証券の円貨利金分配金振込先
            gaikSunkBefore: [
                { target: 'GAIK_SYKN_YEN_SUKN_BK_HKT', get: [getGaikSunkHoukatsu] },
                { target: 'GAIK_SYKN_YEN_SUKN_BK_MEIG', get: [getGaiSunkMeigara] },
        ...
        var notifInfoDefine = {
            ...
            addr: [
                'TIIKI_C',
                'YUBINNO',
                { target: 'YUBINNO', key: 'YUBINNO_1', get: [subStr, 0, 3] },
                { target: 'YUBINNO', key: 'YUBINNO_2', get: [subStr, 3] },
                { target: 'KYAK_ADDR_FLAG', get: [getDefault, '0'] },
                'KYAK_ADDR_KNJ',
                'KYAK_ADDR_KANA',
                'KYAK_ADDR_TDHKN',
                'KYAK_HOSK_ADDR_KNJ',
                'KYAK_HOSK_ADDR_KANA',
                'KYAK_HOUSENM_KNJ',
                { target: 'KYAK_HOUSENM_KNJ', key: 'KYAK_HOUSENM_KNJS', get: [addr3SplitBySpace, 3, '　'] },
                'KYAK_HOUSENM_KANA',
                { target: 'KYAK_HOUSENM_KANA', key: 'KYAK_HOUSENM_KANAS', get: [addr3SplitBySpace, 3, '　'] },
                'TNKY_GNGO',
                'TNKYYMD',
                { target: 'TNKYYMD', key: 'TNKYY', get: [subStr, 0, -4] },
                { target: 'TNKYYMD', key: 'TNKYM', get: [subStr, -4, -2] },
                { target: 'TNKYYMD', key: 'TNKYD', get: [subStr, -2] },
                'NENSY_JSY',
            ...
            tels: [
                ...
                'TELNO2',
                'TELNO3',
                { target: 'TELNO_DEL', get: [getDefault, undefined] },
                'MOBILE_TELNO1',
                'MOBILE_TELNO2',
                'MOBILE_TELNO3',
                { target: 'MOBILE_TELNO_DEL', get: [getDefault, undefined] },
                'FAXNO1',
                'FAXNO2',
                'FAXNO3',
                { target: 'FAXNO_DEL', get: [getDefault, undefined] },
            ],
            // 日興カード
            nkCard: [
        ...
        var checkGroupMaxLength = function (ids, maxLegth, isShowMsgOwn, msgID, msgParams, isShowOneMsgOnly, ...vals) {
            ...
            if (checkExistError.apply(null, ids.split('-')))
                return undefined;
            // Check
        ...
        var sortKeys = {
            ...
            gaikSukn_sk: { sort: 16, name: '外国証券の円貨利金分配金振込先' },
            ruiTouSunk_sk: { sort: 17, name: '分配金受取方法指定（累投）' },
        };
        // 全体チェック: 項目修正済みチェック
        var checkIsModified = function (checkResult) {
            ...
            var tmpName = '電話番号';
            showErrorItemsGroup(target, AppBizCom.Msg.getMsg(msgId, [tmpName]), msgId, true);
        ...
        var checkNameKanjiMaxLength = function () {
            ...
            return checkGroupMaxLength('txtKyaknmSeiKnj-txtKyaknmMeiKnj', 20, true, 'KKAP-SF014-01E', [], true, $scope.name.KYAKNM_SEI_KNJ, $scope.name.KYAKNM_MEI_KNJ);
        };
        // おなまえチェック: おなまえ（漢字）姓の関連チェック（随時）
        var checkNameKanjiSeiMaxLegth = function () {
            if (checkExistError('txtKyaknmSeiKnj', 'txtKyaknmMeiKnj', 'txtKyaknmSeiKnj-txtKyaknmMeiKnj')) {
                return;
            }
        ...
        var checkNameKanaMaxLength = function () {
            return checkGroupMaxLength('txtKyaknmSeiKana-txtKyaknmMeiKana', 29, true, 'KKAP-CM000-19E', ['おなまえ（カナ）', '29'], true, AppCom.StringUtil.zenToHan($scope.name.KYAKNM_SEI_KANA, true), AppCom.StringUtil.zenToHan($scope.name.KYAKNM_MEI_KANA, true));
        };
        // 郵便番号関連チェックエラークリア
        ...
        var checkIsUnknownAddr = function (checkResult) {
            if ($scope.isAddressUnkown ||
                ...
                var value = $scope.modifyFlg[target];
                showErrorItemsGroup(target, AppBizCom.Msg.getMsg(msgId, []), msgId, true);
                checkResult1Update(target, value, msgId, checkResult);
                return true;
            }
            return false;
        ...
        var checkAddr2MaxLength = function () {
            ...
            return checkGroupMaxLength('txtAddr2_1', maxLegth, false, 'KKAP-CM000-09E', ['ご住所②', maxLegth], true, $scope.addr.KYAK_HOSK_ADDR_KNJ);
        };
        ...
        var checklblAddr1IsEmpty = function (checkResult) {
            if ($scope.addr.KYAK_ADDR_FLAG == '0' && AppBizCom.InputCheck.isEmpty($scope.addr.KYAK_ADDR_KNJ)) {
                ...
                showErrorItemsGroup('lblAddr1', AppBizCom.Msg.getMsg(msgId, ['住所', 'ご住所']), msgId, true);
                checkResult1Update(target, value, msgId, checkResult);
                return true;
            }
            else {
        ...
        var checkAddr3MaxLength = function (checkResult) {
            ...
            if (!checkExistError('txtAddr3_1', 'txtAddr3_2', 'txtAddr3_3') && isErrAddr3Vals) {
                ...
                showErrorItemsGroup(target, AppBizCom.Msg.getMsg(msgId, param), msgId, true);
        ...
        var checkTnykDate = function (checkResult) {
            ...
            if (!AppBizCom.InputCheck.isDate($scope.addr.TNKY_GNGO, $scope.addr.TNKYY, $scope.addr.TNKYM, $scope.addr.TNKYD)) {
                ...
                var target = 'TNKYD';
                var value = $scope.addr[target];
                showErrorItemsGroup(ids, AppBizCom.Msg.getMsg(msgId, ['転居日']), msgId, true);
                checkResult1Update(target, value, msgId, checkResult);
                return true;
            }
            // 転居日（元号）＋転居日（年）＋転居日（月）＋転居日（日）が未来日付場合、エラー
        ...
        var checkNensyIsSame = function (checkResult) {
            ...
            if (!tkKozaErrFlg && !addrErrFlg && ($scope.tkKoza.TKTEI_KOZA_NENSY_JSY != $scope.addr.NENSY_JSY)) {
                ...
                showErrorItemsGroup('pldNensyJsy-pldTkteiKozaNensy', AppBizCom.Msg.getMsg(msgId, param), msgId, true);
                showErrorItemsGroup('pldTkteiKozaNensy-pldNensyJsy', AppBizCom.Msg.getMsg(msgId, param), msgId, true);
                if (checkResult) {
        ...
        var checkDelTelMobile = function (checkResult) {
            ...
            if (!checkExistError('chkboxTelDel', 'chkboxMobileTelDel') && delTelnosNotEmpty && delMobileTelnosNotEmpty) {
                ...
                showErrorItemsGroup(ids1, AppBizCom.Msg.getMsg(msgId, param), msgId, true);
                checkResult1Update(target1, value1, msgId, checkResult);
                showErrorItemsGroup(ids2, AppBizCom.Msg.getMsg(msgId, param), msgId, true);
                checkResult1Update(target2, value2, msgId, checkResult);
                return true;
            }
            else {
        ...
        var checkTels = function (checkResult) {
            ...
            if (tels && mobiles && faxs) {
                ...
                var target = 'TELNO_F';
                showErrorMsg('txtTel-txtMobile-txtFax', 'txtTel-txtMobile-txtFax', AppBizCom.Msg.getMsg(msgId, []), msgId);
        ...
        var checkTelMobiles = function (checkResult) {
            ...
            if (oldTels && oldMobiles && tels && mobiles) {
                ...
                var target = 'TELNO_F';
                showErrorMsg('txtTel-txtMobile', 'txtTel-txtMobile', AppBizCom.Msg.getMsg(msgId, []), msgId);
        ...
        var checkKozaDelWithoutAdd = function (checkResult) {
            // 銀行数・ゆうちょ数合計
            ...
            for (var i = 0; i < $scope.kozaModifyFlg.length; i++) {
                if ($scope.kozaDel[i] == '1' && ((kozaGinkoBefore + kozaYuchoBefore) - (kozaDelGinko + kozaDelYucho) + kozaAddGinko + kozaAddYucho <= 0 )) {
                    var msgId = 'KKAP-SFJ06-32E';
                    var target = 'kozaDel_' + (i + 1);
                    var value = undefined;
                    showErrorItemsGroup(target, AppBizCom.Msg.getMsg('KKAP-SFJ06-32E', []), msgId, true);
        ...
        var checkKozaDelIsEmpty = function (checkResult) {
            ...
            for (var i = 0; i < $scope.kozaModifyFlg.length; i++) {
                if ($scope.kozaModifyFlg[i] == '1' && $scope.kozaDel[i] != '1') {
                    ...
                    var target = 'kozaDel_' + (i + 1);
                    var value = undefined;
                    showErrorItemsGroup(target, AppBizCom.Msg.getMsg(msgId, ['受取口座の削除']), msgId, true);
                    checkResult[1]['KOZA_DEL_FS'] = checkResult[1]['KOZA_DEL_FS'] || {};
                    checkResult[1]['KOZA_DEL_FS'][i] = { chkErr: true, chkResult: { value: value, msgId: [msgId] } };
                    errFlg = true;
                }
        ...
        var checkKozaCount = function () {
            ...
            $scope.kozaAdd.KOZA.forEach(e => {
                ...
                if (((kozaGinkoBefore + kozaYuchoBefore) - (kozaDelGinko + kozaDelYucho) + kozaAddGinko + kozaAddYucho > 1)) {
        ...
        var checkKozaOther2 = function (checkResult, kozaAddErrFlg) {
            ...
            for (var j = 0; j < beforeKozaLength; j++) {
                ...
                if (tmpKoza.KOZA_UKTRKZ == '1' && $scope.kozaDel[j] != '1') {
        ...
        // 汎用チェック: 削除対象判定（汎用）
        var checkIsDelNo = function (AcNo) {
        ...
        var checkAcSetted = function (AcNo) {
        ...
        var checkIsYuCyoAc = function (AcNo) {
            for (var i = 0; i < $scope.kozaBefore.KOZA.length; i++) {
        ...
        var checkIsDelSuknHoukatsu = function (checkResult) {
            ...
            if ($scope.suknBefore.SUKN_HOUKATSU.slice(0, 6) != '登録銀行No') {
                return undefined;
            }
        ...
        // 外国証券の円貨利金分配金振込先チェック：外国証券の円貨利金分配金振込先の相関チェック（一括）
        ...
        // 外国証券の円貨利金分配金振込先チェック：銘柄／受取口座1（一括）
        ...
        // 外国証券の円貨利金分配金振込先チェック：支払方法選択（外証） 削除する（受取口座）[X] 相関チェックエラー
        var checkGaikSyknYenSuknAzkr = function (checkResult) {
            ...
            if (deleteKoza.length == 0) {
                ...
                showErrorItemsGroup(target, AppBizCom.Msg.getMsg(msgId, ['支払方法']), msgId, true);
                checkResult1Update(target, value, msgId, checkResult);
                return true;
            }
            else {
        ...
        // 外国証券の円貨利金分配金振込先チェック：登録銀行No.の必須チェック（一括）
        ...
        // 外国証券の円貨利金分配金振込先チェック：登録銀行No.の相関チェック1（一括）
        ...
        // 外国証券の円貨利金分配金振込先チェック：登録銀行No.の相関チェック2（一括）
        ...
        // 外国証券の円貨利金分配金振込先チェック：登録銀行No.の相関チェック3（一括）
        ...
        // 外国証券の円貨利金分配金振込先チェック：登録銀行No.の相関チェック4（一括）
        ...
        // 外国証券の円貨利金分配金振込先チェック：登録銀行No.の相関チェック5（一括）
        ...
        // 分配金受取方法指定（累投）チェック: 「当社から送金する際のお受取口座」の”削除入力”が行われた場合、「累投(株投型)分配金買付停止」の入力を必須とする（一括）
        var checkRuitouSuknKaitTeiBefore = function (checkResult) {
            ...
            if (AppBizCom.InputCheck.isEmpty($scope.ruiTouSunk.RUITOU_SUKN_KAIT_TEIS_K)) {
                ...
                showErrorItemsGroup(target, AppBizCom.Msg.getMsg(msgId, ['分配金受取方法指定（累投）']), msgId, true);
                checkResult1Update(target, value, msgId, checkResult);
                return true;
            }
            else {
        ...
        // 分配金受取方法指定（累投）チェック: 分配金受取方法指定（累投）の相関チェック（一括）
        var checkRuitouSuknKaitTeisk = function () {
            ...
            // 分配金受取方法指定（累投）を選択時、お受取口座で削除選択(ゆうちょ以外)されていない場合エラー。
        ...
        // 分配金受取方法指定（累投）チェック: 分配金受取方法指定（累投）登録銀行No.の必須チェック（一括）
        ...
        // 分配金受取方法指定（累投）チェック: 分配金受取方法指定（累投）登録銀行No.の相関チェック1（一括）
        ...
        // 分配金受取方法指定（累投）チェック: 分配金受取方法指定（累投）登録銀行No.の相関チェック2（一括）
        ...
        // 分配金受取方法指定（累投）チェック: 分配金受取方法指定（累投）登録銀行No.の相関チェック3（一括）
        ...
        // 分配金受取方法指定（累投）チェック: 分配金受取方法指定（累投）登録銀行No.の相関チェック4（一括）
        ...
        // 分配金受取方法指定（累投）チェック: 分配金受取方法指定（累投）登録銀行No.の相関チェック5（一括）
        ...
        var doAllcheck = function () {
            var checkResult = [false, {}, []]; // 全体チェックエラーフラグ
            var enable = '1'; // 変更エリアが表示している
            var unenable = '0'; // 変更エリアが表示していない
            ...
            // 外国証券の円貨利金分配金振込先チェック: 外証の円貨利金分配金振込銀行が変更指定なしで、振込先指定（売却代金）の削除対象が、外証の円貨利金分配金振込銀行で登録されている場合エラー。
            ...
            // 外国証券の円貨利金分配金振込先チェック：外国証券支払方法を選択時、お受取口座で削除選択(ゆうちょも含む)されていない場合エラー。
            ...
            if ($scope.modifyFlg.TELNO_F == enable) {
                ...
                // ⑭ 分配金受取方法指定（累投） $scope.modifyFlg.RUITOU_SUKN_KAIT_TEIS_F
            ...
            var kozaDelWithoutAddErrFlg = checkKozaDelWithoutAdd(checkResult);
            ...
            (kozaDelWithoutAddErrFlg || kozaDelErrFlg || kozaOther1ErrFlg || kozaAddErrFlg.indexOf(true) > -1 || kozaOther2ErrFlg) && checkResult[2].push(sortKeys.kozaAdd_sk);
            (kozaDelWithoutAddErrFlg || kozaDelErrFlg || kozaOther1ErrFlg || kozaAddErrFlg.indexOf(true) > -1 || kozaOther2ErrFlg) && (checkResult[0] = true);
        ...
        var checkSpecItems = function (defines, values, item, checkResult, arrayIndex = undefined) {
            var msgParam = checkResult[1];
            var tempResult = AppLgcMultiCheck.multiInputCheck(defines, values);
        ...
        var inputData = {
            ...
            name: {
                KYAKNM_SEI_KNJ: {
                    applyName: 'KYAKNM_SEI_KNJ',
                    id: 'txtKyaknmSeiKnj',
                    name: 'おなまえ（漢字）姓',
                    requireString: 'full',
                    handWrite: 'text_all',
                    similarType: chkSimilarConst.SIMILAR_CHECK_TYPE.FULL_ALL,
                    typeSelect: false,
                    length: 20,
                    needRequireCheck: true,
                    valChangChk: [[clearNameSeiKanjiError, 'isFullString', 'hasForbidChar', 'chkMaxLength'], [checkNameKanjiSeiMaxLegth], ['hasSimilar']],
                    allChk: [['isEmpty'], ['isFullString', 'hasForbidChar', 'chkMaxLength']],
                },
                KYAKNM_MEI_KNJ: {
                    applyName: 'KYAKNM_SEI_KNJ',
                    id: 'txtKyaknmMeiKnj',
                    ...
                    length: 20,
                    needRequireCheck: true,
                    valChangChk: [[clearNameMeiKanjiError, 'isFullString', 'hasForbidChar', 'chkMaxLength'], [checkNameKanjiMeiMaxLegth], ['hasSimilar']],
                    allChk: [['isEmpty'], ['isFullString', 'hasForbidChar', 'chkMaxLength'], [checkNameKanjiMaxLength]],
                },
                KYAKNM_SEI_KANA: {
                    applyName: 'KYAKNM_SEI_KANA',
                    id: 'txtKyaknmSeiKana',
                    name: 'おなまえ（カナ）姓',
                    requireString: 'full',
                    handWrite: 'text_kana',
                    similarType: chkSimilarConst.SIMILAR_CHECK_TYPE.KANA,
                    typeSelect: false,
                    length: 30,
                    requireHyphen: 'true',
                    valChangChk: [[clearNameSeiKanaError, 'isFullHurigana', 'hasForbidChar', 'chkMaxLength'], [checkNameKanaMaxLength], ['hasSimilar']],
                    allChk: [['isEmpty'], ['isFullHurigana', 'hasForbidChar', 'chkMaxLength']],
                },
                KYAKNM_MEI_KANA: {
                    applyName: 'KYAKNM_MEI_KANA',
                    id: 'txtKyaknmMeiKana',
                    name: 'おなまえ（カナ）名',
                    requireString: 'full',
                    handWrite: 'text_kana',
                    ...
                    length: 30,
                    requireHyphen: 'true',
                    valChangChk: [[clearNameMeiKanaError, 'isFullHurigana', 'hasForbidChar', 'chkMaxLength'], [checkNameKanaMaxLength], ['hasSimilar']],
                    allChk: [['isEmpty'], ['isFullHurigana', 'hasForbidChar', 'chkMaxLength'], [checkNameKanaMaxLength]],
                },
            },
            // ご住所
            addr: {
                YUBINNO_1: {
                    ...
                    length: 3,
                    numPad: true,
                    onBlurChk: [['isNum', 'chkSameLength'], [checkYubinNo1AllZero]],
                    allChk: [['isEmpty'], ['isNum', 'chkSameLength'], [checkYubinNo1AllZero]],
                },
                YUBINNO_2: {
                    applyName: 'YUBINNO_2',
                    id: 'txtAddrNum2',
                    ...
                    allChk: [['isEmpty'], ['isNum', 'chkSameLength']],
                },
                KYAK_ADDR_TDHKN: {
                    applyName: 'KYAK_ADDR_TDHKN',
                    id: 'pldAddrTDFK',
                    name: 'ご住所①（都道府県）',
                    typeSelect: true,
                    allChk: [['isEmpty']],
                ...
                KYAK_HOSK_ADDR_KNJ: {
                    ...
                    typeSelect: false,
                    needRequireCheck: true,
                    valChangChk: [[clearAddr2_1Error, 'isFullString', 'hasForbidChar', checkAddr2MaxLength], [checkAddrsMaxLength], ['hasSimilar']],
                    allChk: [['isEmpty'], ['isFullString', 'hasForbidChar', checkAddr2MaxLength]],
                },
                KYAK_HOSK_ADDR_KANA: {
                    applyName: 'KYAK_HOSK_ADDR_KANA',
                    id: 'txtAddrKana2_1',
                    name: 'ご住所②のフリガナ',
                    requireString: 'full',
                    requireHyphen: 'true',
                    ...
                    typeSelect: false,
                    length: 18,
                    valChangChk: [[clearAddrKana2_1Error, 'isFullHurigana', 'hasForbidChar', checkAddrKana2MaxLength], [checkAddrKanasMaxLength], ['hasSimilar']],
                    allChk: [['isEmpty'], ['isFullHurigana', 'hasForbidChar', checkAddrKana2MaxLength]],
                },
                TNKY_GNGO: {
                    applyName: 'TNKY_GNGO',
                    id: 'pldTnkyGngo',
                ...
                TNKYY: {
                    ...
                    typeSelect: false,
                    numPad: true,
                    onBlurChk: [[clearTnkyYearError, 'isNum'], [checkTnkyGengoYear], [checkTnykGengoYearMonthDay]],
                    allChk: [[checkTnkyYearIsEmpty], ['isNum'], [checkTnkyGengoYear]],
                },
                TNKYM: {
                    applyName: 'TNKYM',
                    id: 'txtTnkyMonth',
                    ...
                    typeSelect: false,
                    numPad: true,
                    onBlurChk: [[clearTnkyMonthError, 'isNum'], [checkTnykMonthFromTo], [checkTnykGengoYearMonthDay]],
                    allChk: [[checkTnkyMonthIsEmpty], ['isNum'], [checkTnykMonthFromTo]],
                },
                TNKYD: {
                    applyName: 'TNKYD',
                    id: 'txtTnkyDay',
                    ...
                    typeSelect: false,
                    numPad: true,
                    onBlurChk: [[clearTnkyDayError, 'isNum'], [checkTnykDayFromTo], [checkTnykGengoYearMonthDay]],
                    allChk: [[checkTnkyDayIsEmpty], ['isNum'], [checkTnykDayFromTo]],
                },
                NENSY_JSY: {
                    applyName: 'NENSY_JSY',
                    id: 'pldNensyJsy',
                    name: '年初住所',
                    typeSelect: true,
                    allChk: [[checkTnkyNensyIsEmpty]],
                },
                MNSYSEIRY_JISN_FLAG: {
                    applyName: 'MNSYSEIRY_JISN_FLAG',
                    id: 'radioMnsyseiryJoho',
                    name: '番号確認書類',
                    typeSelect: true,
                    allChk: [['isEmpty']],
                },
            ...
            addr3: {
                0: {
                    ...
                    length: 14,
                    needRequireCheck: true,
                    valChangChk: [[clearAddr3_1Error, 'isFullString', 'hasForbidChar', 'chkMaxLength'], [checkAddr3MaxLength, checkAddrsMaxLength], ['hasSimilar']],
                    allChk: [['isFullString', 'hasForbidChar', 'chkMaxLength']],
                },
                1: {
                    applyName: 'KYAK_HOUSENM_KNJ',
                    id: 'txtAddr3_2',
                    ...
                    length: 20,
                    needRequireCheck: true,
                    valChangChk: [[clearAddr3_2Error, 'isFullString', 'hasForbidChar', 'chkMaxLength'], [checkAddr3MaxLength, checkAddrsMaxLength], ['hasSimilar']],
                    allChk: [['isFullString', 'hasForbidChar', 'chkMaxLength']],
                },
                2: {
                    applyName: 'KYAK_HOUSENM_KNJ',
                    ...
                    length: 20,
                    needRequireCheck: true,
                    valChangChk: [[clearAddr3_3Error, 'isFullString', 'hasForbidChar', 'chkMaxLength'], [checkAddr3MaxLength, checkAddrsMaxLength], ['hasSimilar']],
                    allChk: [['isFullString', 'hasForbidChar', 'chkMaxLength']],
                },
            },
            // ご住所③カナ～ご住所③カナ追加2
            addr3kana: {
                0: {
                    ...
                    length: 18,
                    needRequireCheck: true,
                    valChangChk: [[clearAddrKana3_1Error, 'isFullHurigana', 'hasForbidChar', checkAddrKana3_1MaxLength], [checkAddrKana3MaxLength, checkAddrKanasMaxLength], ['hasSimilar']],
                    allChk: [['isFullHurigana', 'hasForbidChar', checkAddrKana3_1MaxLength]],
                },
                1: {
                    applyName: 'KYAK_HOUSENM_KANA',
                    id: 'txtAddrKana3_2',
                    ...
                    length: 30,
                    needRequireCheck: true,
                    valChangChk: [[clearAddrKana3_2Error, 'isFullHurigana', 'hasForbidChar', checkAddrKana3_2MaxLength], [checkAddrKana3MaxLength, checkAddrKanasMaxLength], ['hasSimilar']],
                    allChk: [['isFullHurigana', 'hasForbidChar', checkAddrKana3_2MaxLength]],
                },
                2: {
                    applyName: 'KYAK_HOUSENM_KANA',
                    id: 'txtAddrKana3_3',
                    ...
                    length: 30,
                    needRequireCheck: true,
                    valChangChk: [[clearAddrKana3_3Error, 'isFullHurigana', 'hasForbidChar', checkAddrKana3_3MaxLength], [checkAddrKana3MaxLength, checkAddrKanasMaxLength], ['hasSimilar']],
                    allChk: [['isFullHurigana', 'hasForbidChar', checkAddrKana3_3MaxLength]],
                },
            },
            // 電話番号
            tels: {
                TELNO1: {
                    ...
                    numPad: true,
                    // 01-2021-06-172 口座開設事務手続きアプリ改善要望対応 開始 20210913
                    onBlurChk: [[clearTelGroupError, 'isNum', checkTelno1, checkTel12Length, checkTelGroupMaxLength]],
                    allChk: [[checkTelno1IsInGroup], ['isNum', checkTelno1, checkTel12Length]],
                },
                TELNO2: {
                    applyName: 'TELNO2',
                    id: 'txtTelno2',
                    ...
                    numPad: true,
                    // 01-2021-06-172 口座開設事務手続きアプリ改善要望対応 開始 20210913
                    onBlurChk: [[clearTelGroupError, 'isNum', checkTel12Length, checkTelGroupMaxLength]],
                    allChk: [[checkTelno2IsInGroup], ['isNum', checkTel12Length]],
                },
                TELNO3: {
                    applyName: 'TELNO3',
                    id: 'txtTelno3',
                    ...
                    numPad: true,
                    // 01-2021-06-172 口座開設事務手続きアプリ改善要望対応 開始 20210913
                    onBlurChk: [[clearTelGroupError, 'isNum', telLengthCheck3Blur, checkTel12Length, checkTelGroupMaxLength]],
                    allChk: [[checkTelno3IsInGroup], ['isNum', telLengthCheck3, checkTel12Length]],
                },
                TELNO_DEL: {
                    applyName: 'TELNO_DEL',
                    id: 'chkboxTelDel',
                    name: '登録抹消（ご自宅電話番号）',
                    typeSelect: true,
                    allChk: [checkDelTelnos, checkDelTelnos2],
                },
                MOBILE_TELNO1: {
                    applyName: 'MOBILE_TELNO1',
                    id: 'txtMobileTelno1',
                    name: '携帯電話番号１',
                    typeSelect: false,
                    numPad: true,
                    onBlurChk: [[clearMobileGroupError, 'isNum', checkMobileTelno1]],
                    allChk: [[checkMobile1IsInGroup], ['isNum', checkMobileTelno1]],
                },
                MOBILE_TELNO2: {
                    applyName: 'MOBILE_TELNO2',
                    id: 'txtMobileTelno2',
                    name: '携帯電話番号２',
                    typeSelect: false,
                    numPad: true,
                    // 01-2021-06-172 口座開設事務手続きアプリ改善要望対応 開始 20210913
                    onBlurChk: [[clearMobileGroupError, 'isNum', mobileLengthCheck2Blur]],
                    allChk: [[checkMobile2IsInGroup], ['isNum', mobileLengthCheck2]],
                },
                MOBILE_TELNO3: {
                    applyName: 'MOBILE_TELNO3',
                    id: 'txtMobileTelno3',
                    name: '携帯電話番号３',
                    typeSelect: false,
                    numPad: true,
                    // 01-2021-06-172 口座開設事務手続きアプリ改善要望対応 開始 20210913
                    onBlurChk: [[clearMobileGroupError, 'isNum', mobileLengthCheck3Blur]],
                    allChk: [[checkMobile3IsInGroup], ['isNum', mobileLengthCheck3]],
                },
                MOBILE_TELNO_DEL: {
                    applyName: 'MOBILE_TELNO_DEL',
                    id: 'chkboxMobileTelDel',
                    name: '登録抹消（携帯電話番号）',
                    typeSelect: true,
                    allChk: [checkDelMobiles, checkDelMobiles2],
                },
                FAXNO1: {
                    applyName: 'FAXNO1',
                    id: 'txtFaxno1',
                    ...
                    numPad: true,
                    // 01-2021-06-172 口座開設事務手続きアプリ改善要望対応 開始 20210913
                    onBlurChk: [[clearFaxGroupError, 'isNum', checkFaxno1, checkFax12Length, checkFaxGroupMaxLength]],
                    allChk: [[checkFaxno1IsInGroup], ['isNum', checkFaxno1, checkFax12Length]],
                },
                FAXNO2: {
                    applyName: 'FAXNO2',
                    id: 'txtFaxno2',
                    ...
                    numPad: true,
                    // 01-2021-06-172 口座開設事務手続きアプリ改善要望対応 開始 20210913
                    onBlurChk: [[clearFaxGroupError, 'isNum', checkFax12Length, checkFaxGroupMaxLength]],
                    allChk: [[checkFaxno2IsInGroup], ['isNum', checkFax12Length]],
                },
                FAXNO3: {
                    applyName: 'FAXNO3',
                    id: 'txtFaxno3',
                    ...
                    numPad: true,
                    // 01-2021-06-172 口座開設事務手続きアプリ改善要望対応 開始 20210913
                    onBlurChk: [[clearFaxGroupError, 'isNum', faxLengthCheck3Blur, checkFax12Length, checkFaxGroupMaxLength]],
                    allChk: [[checkFaxno3IsInGroup], ['isNum', faxLengthCheck3, checkFax12Length]],
                },
                FAXNO_DEL: {
                    applyName: 'FAXNO_DEL',
                    id: 'chkboxFaxnoDel',
            ...
            nkCard: {
                NIKKO_CARD: {
                    applyName: 'NIKKO_CARD',
                    id: 'radioNikkoCard',
                    name: '申込区分',
                    typeSelect: true,
                    allChk: [['isEmpty'], [checkNkCard]],
                },
            },
            // 日興イージートレード
            ezTrade: {
                NIKKO_EZ: {
                    ...
                    name: '申込区分',
                    typeSelect: true,
                    allChk: [['isEmpty'], [checkNkEZ]],
                },
            },
            // 特定口座
            tkKoza: {
                TKTEI_KOZA_MSKM: {
                    applyName: 'TKTEI_KOZA_MSKM',
                    id: 'radioTkKoza',
                    name: '申込区分',
                    typeSelect: true,
                    allChk: [['isEmpty'], [checkTkteiKozaMskm]],
                },
                TKTEI_KOZA_AC: {
                    applyName: 'TKTEI_KOZA_AC',
                    id: 'radioTkkozaAC',
                    name: '勘定区分',
                    typeSelect: true,
                    allChk: [[checkTkteiKozaAcIsEmpty, checkTkteiKozaAc]],
                },
                TKTEI_KOZA_GNSN: {
                    applyName: 'TKTEI_KOZA_GNSN',
                    id: 'radioTkkozaGNSN',
                    name: '特定口座源泉徴収選択・配当等受入',
                    typeSelect: true,
                    allChk: [[checkTkteiKozaGnsnIsEmpty, checkTkteiKozaGnsn1, checkTkteiKozaGnsn2]],
                },
                TKTEI_KOZA_NENSY_JSY: {
                    applyName: 'TKTEI_KOZA_NENSY_JSY',
                    id: 'pldTkteiKozaNensy',
                    name: '年初住所',
                    typeSelect: true,
                    allChk: [[checkTkteiKozaNensyJsyIsEmpty]],
                },
                TKTEI_KOZA_YYK: {
                    applyName: 'TKTEI_KOZA_YYK',
                    id: 'radioTkKozaYYK',
                    name: '源泉徴収変更予約',
                    typeSelect: true,
                    allChk: [checkTkteiKozaYyk1, checkTkteiKozaYyk2, checkTkteiKozaYyk3],
                },
            },
            // 特定管理口座
            tkKanriKoza: {
                TKTEI_KANRI_KOZA_MSKM: {
                    applyName: 'TKTEI_KANRI_KOZA_MSKM',
                    id: 'chkboxTkteiKanriKozaMskm',
                    name: '開設',
                    typeSelect: true,
                    allChk: [['isEmpty'], [checkTkteiKanriKozaMskm]],
                },
            },
            // NISA口座開設
            nisa: {
                NISA_KOZA_MSKM: {
                    applyName: 'NISA_KOZA_MSKM',
                    id: 'radioNisa',
                    name: 'NISA口座開設',
                    typeSelect: true,
                    allChk: [['isEmpty'], [checkNisaKozaMskm1]],
                },
                HIREIHAIBUN: {
                    applyName: 'HIREIHAIBUN',
                    id: 'radioHireihaibun',
                    name: '株式の配当金等の受け取り方法の選択',
                    typeSelect: true,
                    allChk: [['isEmpty']],
                },
            },
            ...
            myNumber: {
                MYNO_KOKUCHI: {
                    applyName: 'MYNO_KOKUCHI',
                    id: 'chkboxMynoKokuchi',
                    name: '個人番号の登録',
                    typeSelect: true,
                    allChk: [['isEmpty']],
                },
            ...
            suknHoukatsu: {
                SUKN_HKT_AZKR: {
                    applyName: 'SUKN_HKT_AZKR',
                    id: 'radioSuknHoukatsu',
                    name: '支払方法',
                    typeSelect: true,
                    allChk: [['isEmpty'], [checkSuknHktAzkrWithNoAc]],
                },
                SUKN_HKT_TRKNO: {
                    applyName: 'SUKN_HKT_TRKNO',
                    id: 'txtSuknHktTrkno',
                    name: '登録銀行No.',
                    typeSelect: false,
                    length: 2,
                    numPad: true,
                    onBlurChk: [['isNum']],
                    allChk: [[checkSuknHktTrknoIsEmpty], ['isNum', 'chkSameLength'], [checkSuknHktTrkno1, checkSuknHktTrkno2, checkSuknHktTrkno3, checkSuknHktTrkno5, checkSuknHktTrkno7]],
                }
            },
            // 外国証券の円貨利金分配金振込先
            gaikSukn: {
                GAIK_SYKN_YEN_SUKN_AZKR: {
                    applyName: 'GAIK_SYKN_YEN_SUKN_AZKR',
                    id: 'radioGaikSukn',
                    name: '支払方法',
                    typeSelect: true,
                ...
                GAIK_SYKN_YEN_SUKN_BK: {
                    applyName: 'GAIK_SYKN_YEN_SUKN_BK',
                    id: 'txtGaikSyknYen',
                    name: '登録銀行No.',
                    typeSelect: false,
                    length: 2,
                    numPad: true,
                    onBlurChk: [['isNum']],
                    allChk: [[checkGaikSyknYenSuknBkIsEmpty], ['isNum', 'chkSameLength'], [checkGaikSyknYenSuknBk1, checkGaikSyknYenSuknBk2, checkGaikSyknYenSuknBk3, checkGaikSyknYenSuknBk4, checkGaikSyknYenSuknBk5]],
                }
            },
            // 分配金受取方法指定（累投）
            ruiTouSunk: {
                RUITOU_SUKN_KAIT_TEIS_K: {
                    applyName: 'RUITOU_SUKN_KAIT_TEIS_K',
                    id: 'radioRuiTouSunk',
                    name: '支払方法',
                    typeSelect: true,
                    allChk: [['isEmpty'], [checkRuitouSuknKaitTeisk]],
                },
                RUITOU_SUKN_TRKNO: {
                    applyName: 'RUITOU_SUKN_TRKNO',
                    id: 'txtRuitouSuknTrkno',
                    name: '登録銀行No.',
                    typeSelect: false,
                    length: 2,
                    numPad: true,
                    onBlurChk: [['isNum']],
                    allChk: [[checkRuitouSuknTrknoIsEmpty], ['isNum', 'chkSameLength'], [checkRuitouSuknTrkno1, checkRuitouSuknTrkno2, checkRuitouSuknTrkno3, checkRuitouSuknTrkno4, checkRuitouSuknTrkno5]],
                }
            },
        };
        // ------------------------------------ ここから内部処理メッソド START ------------------------------------ //
         ...
         *
         */
        var mstList2RadioList = function (mstList, label = 'MSY', value = 'CD') {
        ...
        var initDataAndFlg = function () {
            ...
            // 複数口座番号フラグ
            $scope.isMultipleKoza = customerInfo.KOZA.length > 1;
            // 三井住友銀行フラグ
            $scope.isSMBCKoza = customerInfo.KOZA.length === 1 && customerInfo.KOZA[0].KOZA_UKTRKZ === '1';
            ...
            $scope.isUktrkzNoChg = customerInfo.CHOHYO_ETRN_CHK == '0' || $scope.isMultipleKoza || !$scope.isSMBCKoza;
            // 変更する（利金・分配金支払方法（包括））ボタン非表示フラグ
            $scope.isSuknHoukatsuNoChg = customerInfo.CHOHYO_ETRN_CHK == '0';
            // 変更する（外国証券の円貨利金分配金振込先）ボタン非表示フラグ
            $scope.isGaikSyknYenNoChg = customerInfo.CHOHYO_ETRN_CHK == '0';
            // 変更する（分配金受取方法指定（累投））ボタン非表示フラグ
            ...
            // // 変更する（外国証券の円貨利金分配金振込先）ボタン非表示フラグ
            // // 外国証券の円貨利金分配金振込先”包括なし””銘柄なし”状態の場合、支払方法の選択は全て不可となるため ”変更する”ボタンを非表示にする。
            // var gaikSyknYenSuknBkHktBeforeIsNasi = ($scope.gaikSunkBefore.GAIK_SYKN_YEN_SUKN_BK_HKT == stringConst.Nasi) ? true : false;
            // var gaikSyknYenSuknBkMeigBeforeIsNasi = ($scope.gaikSunkBefore.GAIK_SYKN_YEN_SUKN_BK_MEIG_NASI) ? true : false;
        ...
        var copyDataWithDefine = function (define, fromData, toObject, defualtGetter = undefined) {
            var getter = angular.isFunction(defualtGetter) ? defualtGetter : function (func, val, params) {
        ...
        var setNotifInfo = function () {
            ...
            notifInfo.JIMU_JOHO = Object.assign(nameJimuJoho, addrJimuJoho, telsJimuJoho, nkCardJimuJoho, ezTradeJimuJoho, tkKozaJimuJoho, tkKanriKozaJimuJoho, nisaJimuJoho, myNumberJimuJoho, addKozaJimuJoho, suknHoukatsuJimuJoho, gaikSuknJimuJoho, ruiTouSunkJimuJoho, 
        ...
        $scope.$watchCollection('kozaModifyFlg', function (newArr, oldArr) {
            if (newArr !== oldArr) {
                if (newArr && newArr[0] === '0') {
                    $scope.kozaAdd.KOZA = [];
                    $scope.$applyAsync();
                }
            }
         ...
         */
        $scope.$watchCollection('kozaDel', function (newArr, oldArr) {
            // 口座未削除数
            $scope.kozaDelCount = newArr.filter(e => e != '1').length;
            // 口座数チェック
            newArr !== oldArr && checkKozaCount();
        });
        /**
         * お受取口座を追加する タップ時
         */
        ...
        $scope.koazaAddInit = function (kozaInfo, scopeId, idx) {
            ...
            $scope.inputData.kozaAdd[idx] = {
                KOZA_KBN: {
                    applyName: 'KOZA_KBN',
                    id: 'radioKozaUktrkz_' + scopeId,
                    name: 'お受取口座',
                    typeSelect: true,
                    allChk: [['isEmpty'], [() => checkKozaCountAllCheck(idx, scopeId)]],
                },
                KOZA_BK_NM: {
                    applyName: 'KOZA_BK_NM',
                    id: 'searchBank_' + scopeId,
                    name: '金融機関',
                    typeSelect: false,
                    allChk: [[() => checkKozaBkNm(idx, scopeId)]],
                },
                KOZA_BK_MISE_NM: {
                    applyName: 'KOZA_BK_MISE_NM',
                    id: 'searchBranch_' + scopeId,
                    name: '支店',
                    typeSelect: false,
                    allChk: [[() => checkKozaBkMiseNm(idx, scopeId)]],
                },
                KOZA_YOKNKND_ADD_BK: {
                    applyName: 'KOZA_YOKNKND_ADD_BK',
                    id: 'txtYoKnKnd_' + scopeId,
                    name: '預金種目',
                    typeSelect: true,
                    allChk: [[() => checkKozaYoknkndAddBkIsEmpty(idx, scopeId)]],
                },
                KOZA_KOZA_CD_ADD_BK: {
                    applyName: 'KOZA_KOZA_CD_ADD_BK',
                    id: 'txtKozaNumber_' + scopeId,
                    name: '口座番号',
                    typeSelect: false,
                    numPad: true,
                    length: 7,
                    onBlurChk: [[() => checkKozaNoIsNum(idx, scopeId)], [() => checkKozaNo(idx, scopeId)]],
                    allChk: [[() => kozaNoPadLeft(idx, scopeId), () => checkKozaNoIsEmpty(idx, scopeId)], [() => checkKozaNoIsNum(idx, scopeId), () => checkKozaNoSamlength(idx, scopeId)], [() => checkKozaNo(idx, scopeId)]],
                },
                KOZA_BK_C_ADD_YUCH: {
                    applyName: 'KOZA_BK_C_ADD_YUCH',
                    id: 'txtYuchBkC_' + scopeId,
                    name: '記号',
                    typeSelect: false,
                    numPad: true,
                    length: 5,
                    onBlurChk: [[() => checkYuchoKigoIsNum(idx, scopeId)], [() => checkYuchoKigo(idx, scopeId)]],
                    allChk: [[() => yuchoKigoPadLeft(idx, scopeId), () => checkYuchoKigoIsEmpty(idx, scopeId)], [() => checkYuchoKigoIsNum(idx, scopeId), () => checkYuchoKigoSamlength(idx, scopeId)], [() => checkYuchoKigo(idx, scopeId)]],
                },
                YUCH_BK_KOZA_CD_ADD_YUCH: {
                    applyName: 'YUCH_BK_KOZA_CD_ADD_YUCH',
                    id: 'txtYuchBkKozaCd_' + scopeId,
                    name: '通帳番号',
                    typeSelect: false,
                    numPad: true,
                    length: 8,
                    onBlurChk: [[() => checkYuchoNoIsNum(idx, scopeId)], [() => checkYuchoNo(idx, scopeId)]],
                    allChk: [[() => yuchoNoPadLeft(idx, scopeId), () => checkYuchoNoIsEmpty(idx, scopeId)], [() => checkYuchoNoIsNum(idx, scopeId), () => checkYuchoNoSamlength(idx, scopeId)], [() => checkYuchoNo(idx, scopeId)]],
                },
            };
        };
        /**
        ...
        $scope.branchSrhBtnClick = function (index, scopeId) {
            ...
            // 金融機関検索
            $scope.searchBranch($scope.kozaAdd.KOZA[index].KOZA_BK_C_ADD_BK, $scope.kozaAdd.KOZA[index].KOZA_BK_NM, $scope.Const.PageID, $scope.Const.brancdsrchPageID, bankBranchSrhCallBack, [index, scopeId, true]);
        };
        /**
        ...
        /**
         * 外国証券の円貨利金分配金振込先支払方法で 登録銀行No以外選択時
