...
App.controller('finalConfirmController', ['$scope', '$controller', 'AppBizDataHolder', 'logicCom', 'AppBizMsg', 'AppLgcMultiCheck', 'AppComDevice',
    function ($scope, $controller, AppBizDataHolder, logicCom, AppBizMsg, AppLgcMultiCheck, AppComDevice) {
        ...
        var strCst = {
            ...
            PAGE_ID_PREV: 'G1240-01',
            PAGE_ID: 'G1260-01',
            PAGE_ID_COMP: 'G1260-03',
            PAGE_ID_ERR: 'G1260-04',
            PAGE_ID_RETURN: 'G1260-05',
            PAGE_ID_NEXT: 'G1270-01',
            PAGE_NAME_NEXT: 'applicationComp',
            PAGE_NAME_PREV: 'applicationConfirm',
            KOFU_HSK: 'KOFU_HSK',
        ...
        var pageCheckInit = function () {
            ...
            var inputData = {
                ...
                [strCst.EIGYOIN_BIKO]: {
                    ...
                    handWrite: 'text_all',
                    length: 30,
                    valChangChk: [['isFullString', 'hasForbidChar', 'chkMaxLength'], ['hasSimilar']],
