...
App.controller('cameraIdBackResultController', ['$scope', '$controller', 'appConst', 'logicCom', 'AppBizCom', 'AppBizCamera',
    function ($scope, $controller, appConst, logicCom, AppBizCom, AppBizCamera) {
        // G1160用処理読み込み
        ...
        var MAIN_PAGE_ID = 'G1180-02'; // 撮影結果表示(1枚目)画面
