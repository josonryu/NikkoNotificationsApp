...
App.controller('cameraIdFrontResultController', ['$scope', '$controller', '$sce', 'appConst', 'logicCom', 'AppBizCom', 'AppBizMsg', 'AppBizCamera',
    function ($scope, $controller, $sce, appConst, logicCom, AppBizCom, AppBizMsg, AppBizCamera) {
        ...
        var MAIN_PAGE_ID = 'G1180-01'; // 撮影結果表示(1枚目)画面
        ...
        var takePicModeOcr = () => {
            ...
            camInfo => {
                ...
                logicCom.setOcrResult2DataHolderJimu(camInfo, () => {
                    ...
                    //     logicCom.change2DefaultView(MAIN_PAGE_ID, undefined, SHOOTING_PAGE_ID);
                    //     // カメラプラグイン終了
                    //     AppBizCamera.deinitCamScan((): void => {}, (): void => {});
                });
                // 01-2022-06-224 本人確認書類撮影画面のガード対応 終了 20221031
            }, 
            // エラー発生時
        ...
        var chkCardTypeMatch = function (selectHoninKakninCD, ocrCardType) {
            ...
            // 本人確認書類コード(一部)
            var SELECT_MY_NUMBER = idTypes[0].CD; // 個人番号カード
            var SELECT_DRIVERS_LICENSE = idTypes[1].CD; // 運転免許証
