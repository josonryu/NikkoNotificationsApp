...
App.controller('confirmCommon', ['$scope', 'AppComDate', 'AppBizDataHolder', 'AppBizCodeMstData',
    function ($scope, AppComDate, AppBizDataHolder, AppBizCodeMstData) {
        ...
        var dateParse = function (date) {
            ...
            switch (date.length) {
                case 6:
                    rtDate = date.substring(0, 2) + '年' + strConst.HALF_SPACE + date.substring(2, 4) + '月' + strConst.HALF_SPACE + date.substring(4, 6) + '日';
                    break;
                case 8:
                    rtDate = date.substring(0, 4) + '年' + strConst.HALF_SPACE + date.substring(4, 6) + '月' + strConst.HALF_SPACE + date.substring(6, 8) + '日';
                    break;
            }
            return rtDate;
        };
        ...
        var loadApplyInfo = function () {
            ...
            serviceTimeJoho.GYOMU_DATE = '20240101';
            // CD-006:サービス時間情報（事務手続き）-> 業務日付
        ...
        var dataBeforeInit = function () {
            ...
            $scope.dataBefore = {
                KYAKNM_KNJ: kyaknmKnj,
                KYAKNM_KANA: kyaknmKana,
                YUBINNO: yubinNo,
                KYAK_ADDR_KNJ: kyakAddrKnj,
                KYAK_ADDR_KANA: kyakAddrKana,
                KYAK_HOSK_ADDR_KNJ: kyakHoskAddrKnj,
                KYAK_HOSK_ADDR_KANA: kyakHoskAddrKana,
                KYAK_HOUSENM_KNJ: kyakHousenmrKnj,
                KYAK_HOUSENM_KANA: kyakHousenmrKana,
                SOUHUSAKI_YBN_BNG: souhusakiYbkzng,
                SOUHUSAKI_JYSY_KNJ: souhusakiJysyKnj,
                SOUHUSAKI_JYSY_KN: souhusakiJysyKn,
                TELNO: telno,
                MOBILE_TELNO: mobileTelno,
                FAXNO: faxno,
                NIKKO_MRF: nikkoMrf,
                NIKKO_CARD: nikkoCard,
                NIKKO_EZ: nikkoEz,
                DNS_KOFU_SRV: dnsKofuSrv,
                GAIK_SYKN_KOZA_OPENYMD: gaikSyknKozaOpenymd,
                TKTEI_KOZA_OPENYMD: tkteiKozaOpenymd,
                TKTEI_KOZA_AC: tkteiKozaAc,
                TKTEI_KOZA_GNSN: tkteiKozaGnsn,
                TKTEI_KOZA_YYK: tkteiKozaYyk,
                TKTEI_KOZA_NENSY_TORIHIKIYMD: tkteiKozaNensyTorihikiymd,
                TKTEI_KANRI_KOZA_OPENYMD: tkteiKanriKozaOpenymd,
                KAKU_KYAKNM_KNJ: kakuKyaknmKnj,
                KAKU_YUBINNO: kakuYubinno,
                KAKU_ADDR: kakuAddr,
                NISA_KOZA_OPENYMD: nisaKozaOpenymd,
                MYNO_KKC: mynoKkc,
                FURIKOMI_KOZA: furikomiKoza,
                SUKN: sukn,
                SUKN_SITEI_K: suknSiteiK,
                GAIK_SYKN_YEN_SUKN_BK_HKT: gaikSyknYenSuknBkHkt,
                MEIG_KOZA: meigKoza,
                UKETORI_HOHO: uketorihoho,
            };
        };
        // データ（変更後）
        var dataAfterInit = function () {
            ...
            // 申込データ(事務手続き).事務手続き情報. 分配金受取方法指定（累投）区分は「3：入金先変更」の場合
            ...
            $scope.dataAfter = {
                ...
                NIKKO_MRF: nikkoMrf,
                NIKKO_CARD: nikkoCard,
                NIKKO_CARD_PIN: nikkoCardPin,
                NIKKO_EZ: nikkoEz,
                GAIK_SYKN_KOZA: gaikSyknKoza,
                TKTEI_KOZA_MSKM: tkteiKozaMskm,
                TKTEI_KOZA_AC: tkteiKozaAc,
                TKTEI_KOZA_GNSN: tkteiKozaGnsn,
                TKTEI_KOZA_YYK: tkteiKozaYyk,
                TKTEI_KOZA_NENSY_JSY: tkteiKozaNensyJsy,
                TKTEI_KANRI_KOZA_MSKM: tkteiKanriKozaMskm,
                KANYUSY_EXP_TORK_K: kanyusyExpTopkK,
                NISA_KOZA_MSKM: nisaKozaMskm,
                NISA_MOSIKOMI_YEAR: gyomuYyyy,
                HIREIHAIBUN: hireihaibun,
                MYNO_KOKUCHI: mynoKokuchi,
                FURIKOMI_KOZA: furikomiKoza,
                SUKN: sukn,
                SUKN_HKT_MEIG_K: suknHktMeigK,
                SUKN_HEN: suknYen,
                RUITOU_SUKN: ruitouSukn,
                HAITKN_SYKN_UKTR_MSKM: haitknSyknUktrMskm,
                AMEIG_FURIKOMI: ameigFurikomi,
            };
        };
        // データ（申込）
        var dataMosikomiInit = function () {
            ...
            $scope.dataMosikomi = {
                MNSYSEIRY_K: mnsyseiryK,
                MYNO: myno,
                HONIN_KAKNIN_SY_K_1: honinKakninSyK1,
                HONIN_KAKNIN_SY1_GAZO1: honinKakninSy1Gazo1,
                HONIN_KAKNIN_SY1_GAZO2: honinKakninSy1Gazo2,
                HONIN_KAKNIN_SY1_GAZO3: honinKakninSy1Gazo3,
                HONIN_KAKNIN_SY_K_2: honinKakninSyK2,
                HONIN_KAKNIN_SY2_GAZO1: honinKakninSy2Gazo1,
                HONIN_KAKNIN_SY2_GAZO2: honinKakninSy2Gazo2,
                HONIN_KAKNIN_SY2_GAZO3: honinKakninSy2Gazo3,
            };
        };
        var pageShowInit = function () {
            ...
            $scope.pageShow = {
                KYAKNM_F: inputFlgControl.KYAKNM_F,
                KYAK_ADDR_F: inputFlgControl.KYAK_ADDR_F,
                TELNO_F: inputFlgControl.TELNO_F,
                NIKKO_MRF_F: inputFlgControl.NIKKO_MRF_F,
                NIKKO_CARD_F: inputFlgControl.NIKKO_CARD_F,
                NIKKO_EZ_F: inputFlgControl.NIKKO_EZ_F,
                GAIK_SYKN_KOZA_F: inputFlgControl.GAIK_SYKN_KOZA_F,
                TKTEI_KOZA_F: inputFlgControl.TKTEI_KOZA_F,
                TKTEI_KANRI_KOZA_F: inputFlgControl.TKTEI_KANRI_KOZA_F,
                KANYUSY_EXP_F: inputFlgControl.KANYUSY_EXP_F,
                NISA_KOZA_F: inputFlgControl.NISA_KOZA_F,
                MYNO_KOKUCHI_F: inputFlgControl.MYNO_KOKUCHI_F,
                KOZA_DEL_F: kozaDelF,
                BK_KOZA_ADD_F: inputFlgControl.BK_KOZA_ADD_F,
                YUCH_KOZA_ADD_F: inputFlgControl.YUCH_KOZA_ADD_F,
                SUKN_HKT_F: inputFlgControl.SUKN_HKT_F,
                SUKN_HKT_MEIG_F: inputFlgControl.SUKN_HKT_MEIG_F,
                GAIK_SYKN_YEN_F: inputFlgControl.GAIK_SYKN_YEN_F,
                RUITOU_SUKN_KAIT_TEIS_F: inputFlgControl.RUITOU_SUKN_KAIT_TEIS_F,
                HAITKN_SYKN_UKTR_F: inputFlgControl.HAITKN_SYKN_UKTR_F,
                MYNO_KOKUCHI_JISN: ('1' === getString(inputFlgControl.MYNO_KOKUCHI_F) || '1' === getString(jimuJoho.MNSYSEIRY_JISN_FLAG)),
                showNikoPin: showNikoPin,
                showTkteiKozaYyk: showTkteiKozaYyk,
                showTkteiKozaHisi: showTkteiKozaHisi,
                showTkteiKozaGnsnMsg: showTkteiKozaGnsnMsg,
                showNisaKozaMskmMsg: showNisaKozaMskmMsg,
                showAmeigFurikomi: showAmeigFurikomi,
                showNoEditLebel: showNoEditLebel,
                showNoEditFirstTitle: showNoEditFirstTitle,
                showImageHnKnSy1Gz1: showImageHnKnSy1Gz1,
                showImageHnKnSy1Gz2: showImageHnKnSy1Gz2,
                imageHnKnSy1Gz2Exist: imageHnKnSy1Gz2Exist,
                showImageHnKnSy1Gz3: showImageHnKnSy1Gz3,
                imageHnKnSy1Gz3Exist: imageHnKnSy1Gz3Exist,
                showImageHnKnSyYuK1: showImageHnKnSyYuK1,
                showHnKnSy2Title: showHnKnSy2Title,
                showImageHnKnSy2Gz1: showImageHnKnSy2Gz1,
                showImageHnKnSy2Gz2: showImageHnKnSy2Gz2,
                imageHnKnSy2Gz2Exist: imageHnKnSy2Gz2Exist,
                showImageHnKnSy2Gz3: showImageHnKnSy2Gz3,
                imageHnKnSy2Gz3Exist: imageHnKnSy2Gz3Exist,
                showImageHnKnSyYuK2: showImageHnKnSyYuK2,
                showMeigKozaNasi: showMeigKozaNasi,
