...
App
    .factory('AppBizCom', ['AppBizInputAssistant', 'AppBizNumKeyboard', 'AppBizAddSearch', 'AppBizBankSearch', 'AppBizMeigaraSearch', 'AppBizCountrySearch', 'AppBizMsg', 'AppBizCheckServTime', 'AppBizEmojiUtil', 'AppBizDataHolder', 'AppBizCodeMstData', 'AppBizInputCheck',
    function (AppBizInputAssistant, AppBizNumKeyboard, AppBizAddSearch, AppBizBankSearch, AppBizMeigaraSearch, AppBizCountrySearch, AppBizMsg, AppBizCheckServTime, AppBizEmojiUtil, AppBizDataHolder, AppBizCodeMstData, AppBizInputCheck) {
        return {
