...
App
    ...
    .factory('AppComClientSls', [function () {
        ...
        var writeFile = function(fileEntry, content) {
           return new Promise((resolve, reject) => {
            fileEntry.createWriter(function(fileWriter) {
                ...
                fileWriter.onerror = function(e) { return reject(e);}
        ...
        var loadFile = function() {
            return new Promise((resolve, reject) => {
                var successFunc = function(dirEntry) {
                    dirEntry.getFile("sls.json", {create: true, exclusive: false }, (fileEntry) => {
                        return resolve(fileEntry);
                    }, (e) => {return reject(e);})
                };
                window.resolveLocalFileSystemURL(cordova.file.dataDirectory, successFunc, (e) => {return reject(e);});
            })
        }

        var sls = {
            setItem: function(successCallback, errorCallback, item) {
                return new Promise((resolve, reject) => {
                    loadFile().then((fileEntry)=> {
                ...
                .then((result) => {
                    return new Promise((resolve, reject) => {
                        loadFile().then((fileEntry) => {
                            ...
                            return writeFile(fileEntry, JSON.stringify(items));
                        }).then(() => {
        ...
        return {
            ...
            setObject: function (time, type, value, successCallback, errorCallback) {
                var key = time + type;
                sls.setItem(successCallback, errorCallback, {key, value: JSON.stringify(value)});
            },
            /**
    ...
    .factory('XmlSerializerUtil', function () {
        return {
    ...
    .service('AppComWindow', [function () {
        this.enterFullScreen = function (successCallBack, errorCallBack) {
        ...
        this.exitFullScreen = function (successCallBack, errorCallBack) {
            if (window.Windows && Windows.UI.ViewManagement.ApplicationView) {
                var applicationView = Windows.UI.ViewManagement.ApplicationView;
                var view = applicationView.getForCurrentView();
        ...
        this.lockScreenOrientation = function () {
